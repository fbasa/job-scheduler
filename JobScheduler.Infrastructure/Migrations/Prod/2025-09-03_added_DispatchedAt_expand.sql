...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20250903003457_added_DispatchedAt'
)
BEGIN
    ALTER TABLE [JobQueue] ADD [DispatchedAt] datetimeoffset NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20250903003457_added_DispatchedAt', N'9.0.8');
END;
